	...
	public class ILMethodElement
	{
		...
		public void ReadToEnd(StreamReader sr)
		{
			...
			while ((s = sr.ReadLine()) != null)
			{
                ...
                //NOTE: evtl switch case... Geschwindigkeit messen
				...
				else if (s.StartsWith(".custom instance"))
				{
                ...
                //erweitert um Trigger.Release() 
                if (s.IndexOf("[SimNet]SimNet.Simulation::Wait") > -1 || s.IndexOf("[SimNet]SimNet.TriggerObj::Release") > -1 || s.IndexOf("[SimNet]SimNet.TriggerObj::Trigger") > -1)
				{
					//WAIT
